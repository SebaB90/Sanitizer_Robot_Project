...
class PowerMatrix (Node):
    ...
    def create_power_matrix(self):
        # Calcolo delle dimensioni della matrice della potenza
        ...
        # Inizializzazione della power matrix a zero
        self.power_matrix = [0] * (self.power_height * self.power_width)

        # Per ogni cella della matrice di potenza calcolo le coordinate sulla mappa e di conseguenza la distanza dal robot
        for id in range(self.power_height * self.power_width ):
            ...
            # Se la cella è all'interno del poligono e la distanza è maggiore di 0.1 (il robot non sanifica così vicino a se stesso) calcolo la potenza
